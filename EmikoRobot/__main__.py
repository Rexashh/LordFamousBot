...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/46340f17954ce7acd7609.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *LFRobot*, a powerful group management bot built to help you manage your group easily."
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/rexashhh/LordFamousBot"),
                 ],
                 [
        ...
        query.message.edit_text(
            text="*๏ LodFamous support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Emiko.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/famouspublic"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/ofclordfamouss"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
        ...
        query.message.edit_text(
            text=f"๏ Credis for LordFamousBot\n"
