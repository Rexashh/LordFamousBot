...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Lord Famous Robot To Your Group ➗",
            url="t.me/lordfamousassistantbot?startgroup=new",
        ),
    ],
]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Source Code",
                            url="https://github.com/rexashhh/LordFamousBot",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="Updates", url="https://t.me/ofclordfamouss"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
